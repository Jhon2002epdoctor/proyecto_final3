...
<header class="header" >
      <nav class="nav">
        ...
        <ul>
          ...
          <li><a href="/proyecto_final/Vista/Conctato.php">conctato</a></li>
        ...
        <?php  
          ...
          ?>
 <a href="/proyecto_final/Vista/Megusta.php">          <i class="fa fa-heart corazones"  class="corazones" style="font-size:24px;color:red"></i>  </i></a>
          <?php
             }
             else{
          ?> 
               <i style="font-size: 24px" class="fa" style="color:black">&#xf004;</i>
          <?php
            }
          ?>
